...
\begin{algorithmic} 
\STATE {$Draw\ the\ triangle$}
\STATE {$Set\ stroke\ using\ mapping\ function\ on\ dna[0]\ for\ food$}
\STATE {$Set\ stroke\ using\ mapping\ function\ on\ dna[1]\ for\ poison$}
\STATE {$Draw\ food\ circle\ using\ dna[2]$}
\STATE {$Draw\ poison\ circle\ using\ dna[3]$}
\end{algorithmic}
\end{algorithm}
